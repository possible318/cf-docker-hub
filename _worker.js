...
// 一个简单的Cloudflare Workers应用程序，用于反代Docker Hub的API请求

// Docker镜像仓库主机地址
let hub_host = 'registry-1.docker.io'
// Docker认证服务器地址
const auth_url = 'https://auth.docker.io'
// 自定义的工作服务器地址 todo 修改为自己的域名地址
let workers_url = 'https://xxx.xxxxx.xxx'
...
function routeByHosts(host) {
    ...
    if (host in routes) return [routes[host], false]; else return [hub_host, true];
}
